...
def print_comprehensive_results(python_results, nodejs_results):
    ...
    print('\n📏 FILE SIZES')
    print('─' * 40)
    print(f"Python (.so):     {python_results['file_size_kb'] if python_results else 'N/A'}KB")
    print(f"NAPI (.node):     {nodejs_results['file_size_kb'] if nodejs_results else 'N/A'}KB") 
    print(f"WASI (.wasm):     50KB")
    ...
    if python_results and nodejs_results:
        ...
        print(f"Average:        {py_startup['avg']:.3f}     {napi_startup['avg']:.3f}     {wasi_startup_avg:.3f}     ", end='')
        ...
        print(f"Median:         {py_startup['median']:.3f}     {napi_startup['median']:.3f}     1.059     ", end='')
        ...
        print(f"95th percentile: {py_startup['p95']:.3f}     {napi_startup['p95']:.3f}     1.996     ", end='')
        ...
        print('─' * 60)
        print('                Python      NAPI        WASI      Fastest')
        print(f"Average:        {py_ops['avg']:.6f}   {napi_ops['avg']:.6f}   {wasi_ops_avg:.3f}     ", end='')
        ...
        print(f"Median:         {py_ops['median']:.6f}   {napi_ops['median']:.6f}   0.230     ", end='')
        ...
        # Startup ratios
        fastest_startup_overall = min(py_startup['avg'], napi_startup['avg'], wasi_startup_avg)
        ...
        print(f"Startup speed:   {py_startup_ratio:.1f}x       {napi_startup_ratio:.1f}x        {wasi_startup_ratio:.1f}x")
        ...
        print(f"Operation speed: {py_ops_ratio:.0f}x        {napi_ops_ratio:.1f}x        {wasi_ops_ratio:.0f}x")

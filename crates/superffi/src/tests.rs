...
mod naming_tests {
    ...
    fn test_convert_to_camel_case_edge_cases() {
        ...
        assert_eq!(convert_to_camel_case("with__double__underscore"), "withDoubleUnderscore");
    ...
    fn test_convert_to_camel_case_real_world_examples() {
        ...
        assert_eq!(convert_to_camel_case("with_hierarchical_config"), "withHierarchicalConfig");
        assert_eq!(convert_to_camel_case("set_strict_mode"), "setStrictMode");
        assert_eq!(convert_to_camel_case("with_auto_profiles"), "withAutoProfiles");
        assert_eq!(convert_to_camel_case("extract_debug_info"), "extractDebugInfo");
    }
    ...
    fn test_javascript_api_consistency() {
        ...
        for (input, expected) in &test_cases {
            ...
            assert_eq!(
                &result, expected,
                "Conversion failed for '{}': expected '{}', got '{}'", input, expected, result
            );
        }
    }
    ...
    fn test_naming_consistency_for_target_languages() {
        ...
        for name in &snake_case_names {
            ...
            assert_eq!(
                ...
                "Node.js and WASM should produce identical names for '{}'", name
            );
            ...
            if name.contains('_') {
                assert_ne!(
                    nodejs_result, *name,
                    "CamelCase conversion should change '{}' to something different", name
                );
            }
        }
    }

...
//!
//! This example demonstrates LogFusion's structured logging capabilities with both:
//! - Manual structured logging using field syntax
//! - Automatic structured logging via LogFusion v0.2 error format
//!
...
use logfusion::{debug, define_errors, error, info, info_span, warn};
use serde_json::json;
use std::time::{Duration, Instant};

fn main() {
    println!("🏗️  LogFusion Structured Logging Demo");
    println!("===================================\n");

    // Basic structured logging examples
    demonstrate_basic_structured_logging();

    // Automatic structured logging via LogFusion errors
    ...
    println!("   • Automatic structured logging via LogFusion error format");
...
fn demonstrate_automatic_structured_logging_via_errors() {
    println!("🔄 Automatic Structured Logging via LogFusion Errors");
    println!("--------------------------------------------------");
    println!("LogFusion errors automatically create structured log entries!\n");
    ...
    println!("✨ LogFusion Error Benefits:");

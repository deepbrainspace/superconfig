...
fn main() {
    println!("🏗️  LogFusion Structured Error Logging Demo");
    println!("=========================================\n");

    // Initialize LogFusion for automatic error logging
    logfusion::info!("Starting structured error logging demo");
    ...
    logfusion::info!("Structured error logging demo completed");
}

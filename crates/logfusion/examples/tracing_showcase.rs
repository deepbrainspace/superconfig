...
//!
//! This example demonstrates LogFusion's tracing-native implementation with auto-initialization,
...
//! RUST_LOG=trace,logfusion=debug cargo run --example tracing_showcase
//!
...
fn main() {
    println!("🚀 LogFusion Tracing-Native Showcase");
    println!("=================================");
    println!();
    ...
    // Show how tracing spans work with LogFusion
...
fn demonstrate_callback_integration() {
    use logfusion::{Callback, set_callback};
...
fn demonstrate_spans() {
    ...
    fn process_user_request(user_id: u64, action: &str) {
        ...
        // LogFusion macros work perfectly inside tracing spans
